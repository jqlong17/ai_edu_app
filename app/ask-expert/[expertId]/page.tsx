...
import ExpertDetailClient from './client'
...
export function generateMetadata({ params }: { params: { expertId: string } }): Metadata {
  ...
  return {
    ...
    description: `与${expert.name}对话，获取专业的${expert.title}指导和建议。`
  }
}

// 服务器组件
export default function ExpertDetailPage({ params }: { params: { expertId: string } }) {
  return <ExpertDetailClient params={params} />
} 